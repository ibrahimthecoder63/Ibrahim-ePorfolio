...
export default function Hero() {
  return (
    <section id="top" className="relative min-h-[100dvh] flex items-center pt-20 overflow-hidden">
      {/* Background graphic */}
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="max-w-4xl">
          ...
          >
            ...
            <span className="text-xs font-mono font-medium uppercase tracking-wider">Available for new opportunities</span>
          </motion.div>
          ...
          >
            Ibrahim <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Mammadov</span>
          </motion.h1>
          ...
          >
            Just a young programmer aspiring to do great things. Crafting digital experiences that merge clean code with beautiful design.
          </motion.p>
